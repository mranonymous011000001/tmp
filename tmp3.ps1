...
$Paths = @(
    "/",
    "/schoolexpert",
    "/schoolexpert/modules.asp",
    "/schoolexpert/modules.php",
    "/schoolexpert/dashboard.asp",
    "/schoolexpert/dashboard.php",
    "/schoolexpert/dashboardv2.asp",
    "/schoolexpert/dashboardv2.php",
    ...
    "/schoolexpert/jquery-1.7.2.min.js"
)
